    ...
    BANANA_PROJECT_REPORT: (
        (_('Total Community Contribution'),
            ('exp_contribution',
             'actual_contribution',
             'community_contribution')),
        (_('Number of plantlets acquired using project funds'),
            ('plantlets_target',
             'plantlets_achievement',
        ...
        (_('Number of plantlets acquired using \
            ...
            ('plantlets_proceeds_target',
             'plantlets_proceeds_achievement',
             'plantlets_proceeds_percentage')),
        (_('Total acreage under Tissue Culture Bananas'),
            ('acreage_target',
             'acreage_achievement',
             'acreage_percentage')),
        (_('Total bunches of bananas harvested'),
            ('bb_harvested_target',
             'bb_harvested_achievement',
             'bb_harvested_percentage')),
        (_('Total number of direct beneficiaries'),
    ...
    FISH_FARMING_PROJECT_REPORT: (
        (_('Total Community Contribution'),
            ('exp_contribution',
             'actual_contribution',
             'community_contribution')),
        (_('Number of ponds acquired using project funds'),
            ('ponds_pf_target',
             'ponds_pf_achievement',
             'ponds_pf_percentage')),
        (_('Number of ponds acquired constructed using proceeds \
            and other contributions'),
            ('ponds_proceeds_target',
             'ponds_proceeds_achievement',
             'ponds_proceeds_percentage')),
        (_('Number of fingerlings acquired using project funds'),
            ('fingerlings_target',
             'fingerlings_achievement',
             'fingerlings_percentage')),
        (_('Number of fingerlings acquired using proceeds \
            and other contributions'),
            ('fl_proceeds_target',
             'fl_proceeds_achievement',
             'fl_proceeds_percentage')),
        (_('Total number of fish harvested'),
            ('fh_target',
             'fh_achievement',
             'fh_percentage')),
        (_('Total number of fish sold'),
            ('fs_target',
             'fs_achievement',
             'fs_percentage')),
        (_('Total number of direct beneficiaries'),
    ...
    OXEN_PLOUGH_PROJECT_REPORT: (
        ...
        (_('Number of oxen ploughs acquired using project funds'),
            ('op_target',
             'op_achievement',
             'op_percentage')),
        (_('Number of oxen ploughs acquired using proceeds \
            and other contributions'),
            ('op_proceeds_target',
             'op_proceeds_achievement',
             'op_proceeds_percentage')),
    ...
    TAILORING_PROJECT_REPORT: (
        ...
        (_('Number of tailoring machines acquired using project funds'),
            ('tm_pf_target',
             'tm_pf_achievement',
             'tm_pf_percentage')),
        (_('Number of tailoring machines acquired using proceeds \
            and other contributions'),
            ('tm_proceeds_target',
             'tm_proceeds_achievement',
             'tm_proceeds_percentage')),
        ...
        (_('Number of vulnerable beneficiaries'),
            ('vb_target',
             'vb_achievement',
             'vb_percentage')),
        (_('Monthly average income earned from sale of sewed items \
            by the group'),
            ('grp_income_target',
             'grp_income_achievement',
             'grp_income_percentage')),
