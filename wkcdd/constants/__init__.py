...
PERFORMANCE_INDICATORS = {
    ...
    BODABODA_PROJECT_REPORT:
        ('exp_contribution', 'perfomance_summary/exp_contribution',
         ...
         'mbs_proceeds_achievement', 'mproject_performance/mbs_proceeds_achievement',
         'mbs_proceeds_percentage', 'mproject_performance/mbs_proceeds_percentage',
         ...
         'bnf_income_target', 'impact_information/bnf_income_target',
         'bnf_income_achievement', 'impact_information/bnf_income_achievement',
         'bnf_income_percentage', 'impact_information/bnf_income_percentage'
         )
    ,
    POULTRY_PROJECT_REPORT:
        ('exp_contribution', 'perfomance_summary/exp_contribution',
         ...
         'birds_proceeds_target', 'mproject_performance/birds_proceeds_target',
         'birds_proceeds_percentage', 'mproject_performance/birds_proceeds_percentage',
         'birds_proceeds_achievement', 'mproject_performance/birds_proceeds_achievement',
         ...
         'bnf_income_achievement', 'mproject_performance/bnf_income_achievement',
