...
FIELD_INDUSTRIAL_CROPS_PROJECT_REGISTRATION = \
    'field_industrial_crops_project_registration'
FIELD_INDUSTRIAL_CROP_PROJECT_REPORT = 'field_industrial_crop_project_report'
...
PROJECT_REGISTRATION_FORMS = (
    ...
    DAIRY_COWS_PROJECT_REGISTRATION,
    FIELD_INDUSTRIAL_CROPS_PROJECT_REGISTRATION,
    BODABODA_PROJECT_REGISTRATION,
    POULTRY_PROJECT_REGISTRATION
)

PROJECT_REPORT_FORMS = (
    DAIRY_GOAT_PROJECT_REPORT,
    DAIRY_COWS_PROJECT_REPORT,
    FIELD_INDUSTRIAL_CROP_PROJECT_REPORT,
